...
exports.listAllMedicines = listAllMedicines;
exports.searchByCountry = searchByCountry;
exports.forceUpdate = forceUpdate;
exports.fuzzySearch = fuzzySearch;
const ema_medicine_mapper_1 = require("./ema-medicine-mapper");
// Initialize mapper
const emaMapper = new ema_medicine_mapper_1.EMAMedicineMapper('assets/ema-report.csv', true // auto-update enabled
);
/**
...
async function basicSearch() {
    ...
    const results = await emaMapper.getPaginatedMedicines(1, // page
    10, // pageSize
    'aspirin' // query
    );
...
async function fuzzySearch() {
    ...
    // Search with typo
    const results = await emaMapper.getPaginatedMedicines(1, 5, 'aspirn', // typo
...
//# sourceMappingURL=ema-usage-example.js.map