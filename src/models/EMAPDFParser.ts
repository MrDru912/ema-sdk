...
private extractSection(
  ...
  if (startMatch && startMatch.index !== undefined) {
    ...
    } else console.log("endMatch undefined, end of the section was not found " + endMatch)

    const sectionContent = text.slice(sectionStart, sectionEnd).trim();
    return sectionContent;
  } else console.log("startMatch undefined, start of the section was not found " + startMatch)
}
  ...
  parseDocument(mdText: string): Partial<ExtractedPDFData> {
    ...
    extracted.nameOfMedicalProduct = this.extractSection(
      mdText,
      '1',
      '2'
    );
    ...
    extracted.qualitativeAndQuantitativeComposition = this.extractSection(
      mdText,
      '2',
      '3'
    );
    ...
    extracted.pharmaceuticalForm = this.extractSection(
      mdText,
      '3',
      '4'
    );
    ...
    extracted.therapeuticIndications = this.extractSection(
      mdText,
      '4.1',
      '4.2',
    );
    ...
    // Section 4.2 - Posology and method of administration
    extracted.posologyAndAdministration = this.extractSection(
      mdText,
      '4.2',
      '4.3',
    ...
    extracted.contraindications = this.extractSection(
      mdText,
      '4.3',
      '4.4',
      'contraindications',
    ...
    extracted.specialWarnings = this.extractSection(
      mdText,
      '4.4',
      '4.5',
    ...
    extracted.interactions = this.extractSection(
      mdText,
      '4.5',
      '4.6',
      'interaction',
    ...
    extracted.fertilityPregnancyLactation = this.extractSection(
      mdText,
      '4.6',
      '4.7',
      'fertility',
    ...
    extracted.effectsOnDriving = this.extractSection(
      mdText,
      '4.7',
      '4.8',
    ...
    extracted.adverseReactions = this.extractSection(
      mdText,
      '4.8',
      '4.9',
      'undesirable effects',
    ...
    extracted.overdose = this.extractSection(
      mdText,
      '4.9',
      '5',
      'overdose',
    ...
    extracted.pharmacologicalProperties = this.extractSection(
      mdText,
      '5.1',
      '5.2',
    ...
    extracted.pharmacokinetics = this.extractSection(
      mdText,
      '5.2',
      '5.3',
    ...
    extracted.preclinicalData = this.extractSection(
      mdText,
      '5.3',
      '6',
