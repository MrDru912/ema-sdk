...
An open-label randomised clinical trial in patients with type 2 diabetes not reaching target with oral
...
vs. to 8.24%), a greater decline in fasting plasma glucose (to 7.20 mmol/l vs. to 8.13 mmol/l), and a
...
The trial including children above 2 years was extended for an additional 12 months (total of
...
- Deliver the dose by pressing the push-button fully down (picture D). You will hear clicks as
...
(^) E
Always use a new needle for each injecti on.Always remove and discard the needle after each injection
...
6, Contents of the pack and other information.
► If you suspect hypoglycaemia (low blood sugar) is starting, see a) Summary of serious and very
common side effects i n section 4.
► In insulin infusion pumps.
...
► Levemir FlexTouch is only suitable for injecting under the skin. Speak to your doctor if you
...
► If you are going abroad, travelling over time zones may affect your insulin needs and the timing
of your injections.
► If you have very low albumin you need to carefu lly monitor your blood sugar level. Discuss this
with your doctor.
...
Levemir is for injection under the skin (subcutaneously). You must never inject Levemir directly into
a vein (intravenously) or muscle (intramuscularly). Levemir FlexTouch is only suitable for injecting
under the skin. Speak to your doctor if you need to inject your insulin by another method.
...
Before opening: Levemir FlexTouch that is not being used is to be stored in the refrigerator at 2°C to
8°C, away from the cooling element. Do not freeze.

During use or when carried as a spare: You can carry your Levemir FlexTouch with you and keep it
at a temperature below 30°C or in a refrigerator (2°C to 8°C) for up to 6 weeks. If refrigerated, keep
away from the cooling element. Do not freeze.
...
Instructions on how to use Levemir 100 units/ml solution for injection in pre-filled pen
(FlexTouch)
...
Start by checking your pen to make sure that it contains Levemir 100 units/ml, then look at the
...
Your Levemir FlexTouch pen is a pre-filled insulin pen Levemir FlexTouch contains 300 units of
insulin and delivers doses from 1 to 80 units, in increments of 1 unit.
Levemir FlexTouch is designed to be used with NovoFine or NovoTwist single-use disposable
...
Use the dose selector on your Levemir FlexTouch pen to select your dose. You can select up to
80 units per dose.
...
Turn the dose selector until the dose counter stops. If it shows 80, at least 80 units are left in
your pen.
...
```
```
If you need more insulin than the units left in your pen, you can split your dose between two
pens.
```
...
```
```
When the pen is empty, throw it away without a needle on as instructed by your doctor, nurse,
pharmacist or local authorities.
```
L

```
Always watch the dose counter to know how many units you inject. The dose counter will
show the exact number of units. Do not count the pen clicks.
...
- Do not wash, soak or lubricate your pen. If necessary, clean i t with mild detergent on a
    moistened cloth.
- Do not drop your pen or knock it against hard surfaces. If you drop it or suspect a problem,
    attach a new needle and check the insulin flow before you inject.
